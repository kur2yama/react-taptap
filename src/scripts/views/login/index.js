...
export class Login extends Component {
    ...
    render() {
        ...
        return (
            <div style={{ backgroundColor: "#fff" }} className="loginPage">
                <Myhead title="TapTap-登录" show="true" />
                <div style={{ height: 50 }}></div>
                <div>
                    <h3 style={{ fontSize: 50, textAlign: "center", color: "#00caca", marginTop: 10 }}>TapTap</h3>
                    <p style={{ fontSize: 16, textAlign: "center", color: "#00caca", marginTop: 10, marginBottom: 10 }}>即刻加入游戏狂热者行列</p>
